...
export default function NovaDemanda({ perfil }) {
  ...
  const [f, setF] = useState({ titulo: '', origem: 'candidato', candidato_id: '', peca: 'Colinha', largura_mm: 70, altura_mm: 100, material: 'Couchê 90g', forma: 'ret', molde: '', quantidade: '', prazo: '', briefing: '' })
  ...
  async function salvar(e) {
    ...
    const row = { ...f, molde: f.molde || null, candidato_id: f.candidato_id || null, quantidade: f.quantidade || null, prazo: f.prazo || null, criado_por: perfil?.id }
